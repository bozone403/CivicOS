...
export function registerElectionsRoutes(app: Express) {
  ...
  app.get("/api/elections/system/info", async (req: Request, res: Response) => {
    try {
  ...
  app.get("/api/elections/voter-info", async (req: Request, res: Response) => {
    try {
  ...
  app.get("/api/elections/results/recent", async (req: Request, res: Response) => {
    try {
