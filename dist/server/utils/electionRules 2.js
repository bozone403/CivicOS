...
function firstWeekdayOfMonth(year, monthIndex0, weekday) {
...
export function nextMunicipalElectionDate(province, fromDate = new Date()) {
...
export function nextFederalElectionDate(fromDate = new Date()) {
