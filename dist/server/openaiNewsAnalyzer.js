...
export class OpenAINewsAnalyzer {
    ...
    async scrapeAndAnalyzeSource(source) {
        try {
...
Provide analysis in JSON format:
{
  ...
  "summary": "brief summary"
    ...
    async storeArticleAnalysis(article, analysis, source) {
        try {
    ...
    async performCrossSourceComparison() {
        try {
    ...
    async compareTopicCoverage(topic) {
        try {
    ...
    async generateTopicComparison(topic, articles) {
        try {
...
Provide comparison in JSON format:
{
  ...
  "overallTrend": "positive|negative|neutral"
    ...
    async storeComparison(topic, comparison) {
        try {
            await db.execute(sql `
