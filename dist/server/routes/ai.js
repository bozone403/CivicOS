...
Provide a comprehensive, accurate, and actionable response focused on Canadian civic engagement. Include specific resources, contact information, and next steps when relevant. Be informative, professional, and empowering.`;
    ...
    app.post('/api/ai/political-insights', jwtAuth, async (req, res) => {
        try {
            const { data } = req.body;
    ...
    app.post('/api/ai/civic-recommendations', jwtAuth, async (req, res) => {
        try {
    ...
    app.post('/api/ai/analyze-news-bias', jwtAuth, async (req, res) => {
        try {
    ...
    app.post('/api/ai/legislative-summary', jwtAuth, async (req, res) => {
        try {
    ...
    app.post('/api/ai/civic-intelligence-report', jwtAuth, async (req, res) => {
        try {
            const { data } = req.body;
