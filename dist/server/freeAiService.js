...
export class FreeAiService {
    ...
    huggingFaceUrl = 'https://api-inference.huggingface.co/models/microsoft/DialoGPT-large';
    constructor() {
     ...
     */
    async chat(message, conversationHistory = [], civicContext) {
     ...
     */
    async chatWithHuggingFace(message, conversationHistory, civicContext) {
     ...
     */
    async chatWithFallback(message, conversationHistory, civicContext) {
     ...
     */
    generateCivicSystemPrompt(civicContext) {
...
Respond as a helpful civic assistant focused on Canadian democracy and government accountability.`;
     ...
     */
    formatPromptForHuggingFace(message, history, systemPrompt) {
     ...
     */
    generateBillResponse(message, civicContext) {
     ...
     */
    generatePoliticianResponse(message, civicContext) {
     ...
     */
    generateVotingResponse(message, civicContext) {
        return {
     ...
     */
    generateNewsResponse(message, civicContext) {
     ...
     */
    generateLegalResponse(message, civicContext) {
        return {
     ...
     */
    generateGeneralCivicResponse(message, civicContext) {
        const responses = [
     ...
     */
    extractRelatedTopics(message, civicContext) {
